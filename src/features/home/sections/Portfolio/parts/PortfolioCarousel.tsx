  ...
  return (
    <motion.div className="mt-14" variants={variants}>
      ...
      >
        ...
        <CarouselPrevious className="left-16 sm:left-20 md:left-28 z-20 border-brass/40 text-brass opacity-0 transition-opacity group-hover:opacity-100" />
        <CarouselNext className="right-16 sm:right-20 md:right-28 z-20 border-brass/40 text-brass opacity-0 transition-opacity group-hover:opacity-100" />
      </Carousel>
    </motion.div>
  );
};
